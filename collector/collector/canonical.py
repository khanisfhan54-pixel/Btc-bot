...
class CanonicalEvent:
    ...
    local_receive_ts: int; local_process_ts: Optional[int] = None; market_type: str = "linear_perpetual"
...
class CanonicalOrderBookEvent(CanonicalEvent):
    ...
    sequence: Optional[int] = None; is_snapshot: bool = False

@dataclass(frozen=True)
class CanonicalTradeEvent(CanonicalEvent):
    trade_id: Optional[int] = None; price: float = 0.0; quantity: float = 0.0; side: Optional[str] = None; nq: Optional[float] = None
