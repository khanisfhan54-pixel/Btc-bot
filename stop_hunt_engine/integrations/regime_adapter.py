...
def map_regime_output(regime_payload: Mapping[str, Any] | None) -> dict[str, Any]:
    if not regime_payload:
        return {"regime_label": "", "confidence": 0.0, "conviction": 0.0, "edge_score": 0.0, "signal_valid": False, "expected_volatility": 0.0}
    return {
